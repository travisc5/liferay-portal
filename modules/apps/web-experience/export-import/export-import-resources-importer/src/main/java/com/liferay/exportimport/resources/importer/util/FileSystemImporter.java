	...
	protected void addLayoutColumnPortlet(
		...
		while (iterator.hasNext()) {
			...
			if (rootPortletId.equals(_RSS_FEED_PORTLET_ID) &&
				...
				ArrayList<String> preferenceValueArrayList = new ArrayList<String>();
